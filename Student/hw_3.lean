...
#eval l2l String.length ["My", "name", "is", "Preethi."]
...
inductive PRFV (α : Type) -- curly braces are for when you want lean to infer what the type is
| undefined
| defined (a : α)
...
| Nat.zero => @PRFV.undefined Nat
| Nat.succ a => PRFV.defined a
